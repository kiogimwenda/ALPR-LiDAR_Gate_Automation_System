...
| `docs/hardware/10-pcb-design-kicad10.{html,pdf}` | Step-by-step KiCad 10.0 guide (rev 2.1, 61 pp — pin map synchronized with firmware v1.0.0; 5V rail feedback divider and buck protection diodes corrected) for the custom 4-layer field PCB — schematic capture, footprint selection, layer stack, copper pours, DRC, gerber export, JLCPCB upload. |
